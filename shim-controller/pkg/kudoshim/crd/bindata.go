...
// sources:
// config/crds/kudoshim.dev_shiminstances.yaml
package crd
...
var _bindata = map[string]func() (*asset, error){
	"config/crds/kudoshim.dev_shiminstances.yaml": configCrdsKudoshimDev_shiminstancesYaml,
}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"config": &bintree{nil, map[string]*bintree{
		"crds": &bintree{nil, map[string]*bintree{
			"kudoshim.dev_shiminstances.yaml": &bintree{configCrdsKudoshimDev_shiminstancesYaml, map[string]*bintree{}},
		}},
	}},
}}
