...
CODE_GEN_DIR="${REPO_ROOT}/shim-controller/hack/code-gen/$VERSION"
...
FAKE_REPOPATH="${FAKE_GOPATH}/src/github.com/kudobuilder/shim"
...
"${CODE_GEN_DIR}"/generate-groups.sh \
 all \
  github.com/kudobuilder/shim/shim-controller/pkg/generated github.com/kudobuilder/shim/shim-controller/pkg/apis \
  "kudoshim:v1alpha1" \
